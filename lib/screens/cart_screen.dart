...
//   // A Map to hold local quantities for each product in the cart
//   late Map<int, int> localQuantities;
//
//   @override
//   void initState() {
//     super.initState();
//     // Initialize local quantities based on the cart items
...
//                               const SizedBox(height: 10.0,),
//                               Text('Price: \$${(product.price * localQuantities[cartItem.productId]!).toStringAsFixed(2)}',style: const TextStyle(fontSize: 20.0),),
